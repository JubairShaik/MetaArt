    ...
    <nav className="flexBetween w-full fixed z-10 p-4 flex-row border-b dark:bg-nft-dark bg-white dark:border-nft-black-1 border-nft-gray-1">
      <div className="flex flex-1 flex-row justify-start">
        <Link href="/">
          <div className="flexCenter md:hidden cursor-pointer" onClick={() => setActive('Explore NFTs')}>
            ...
            <p className=" dark:text-white font-poppins text-nft-black-1 font-semibold text-lg ml-1">MetaArt</p>
          </div>
        </Link>
        <Link href="/">
          <div
      ...
      <div className="flex items-center mr-2">
          ...
          <label htmlFor="checkbox" className="flexBetween w-8 h-4 bg-black rounded-2xl p-1 relative label">
             <TiWeatherSunny  className="text-yellow-400 h-5"/> {/* Render the sun icon */}
             <IoMoonOutline className="text-yellow-600 h-3" /> {/* Render the moon icon */}
            <div className="w-3 h-3 p-1 absolute bg-white rounded-full ball" />
          </label>
        </div>
