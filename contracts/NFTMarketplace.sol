...
contract NFTMarketplace is ERC721URIStorage {
    ...
    struct MarketItem { //Similar to JS-Object

        uint256 tokenId;
        address payable seller;
        address payable owner;
        uint price;
        bool sold; //====> Wheather the Item is Sold or Not 

    }

    // ------ EVENT Triggerd Upon Some Action ------
    ...
    // updateListingPrice(0.025 ether);
    // }
    ...
    // msg.sender is the Owner ( The One Who is Deploying is The Owner )
    // owner will be payabale , once he/she Sells the NFT 
  ...
  function createMarketItem(uint256 tokenId, uint256 price) private { 
    ...
    //createMarketItem is private Because its used in only while CreatingToken
